...
<body>
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                         ...
                         </li><li><a href="pricing.php">Услуги</a></li>
    ...
    <section class="pricing-page">
               ...
               <?php
                    ...
                    $data = mysqli_query($link, "SELECT * FROM `id1489014_penzabus`.`carPark` WHERE `type` = 'автобус'");
                    while($row = mysqli_fetch_assoc($data)){
                        ...
                        <ul>
                            ...
                            echo "<img src ='/images/autobus/{$row['img']}'>";
